...
public:
    ...
    void draw_image_part(painter &ctx, const image_t *img, int offset, float x, float y, color color = COLOR_WHITE, float scale = 1.f, ImgFlags flags = ImgFlag_None);
    void draw_image(painter &ctx, const image_t* img, float x, float y, color color = COLOR_WHITE, float scale = 1.f, ImgFlags flags = ImgFlag_None);
    void draw_image_grayscale(painter &ctx, const image_t* img, float x, float y, float scale = 1.f, ImgFlags flags = ImgFlag_None);

...
static hotkey_widget hotkey_widgets[] = {
  ...
  {HOTKEY_BUILD_FIREHOUSE, TR_NONE, GROUP_BUILDINGS, BUILDING_FIREHOUSE},
  {HOTKEY_BUILD_ARCHITECT, TR_NONE, GROUP_BUILDINGS, BUILDING_ARCHITECT_POST},
  {HOTKEY_BUILD_APOTHECARY, TR_NONE, GROUP_BUILDINGS, BUILDING_APOTHECARY},
  ...
  {HOTKEY_BUILD_BAZAAR, TR_NONE, GROUP_BUILDINGS, BUILDING_BAZAAR},
  ...
  {HOTKEY_BUILD_WATERLIFT, TR_NONE, GROUP_BUILDINGS, BUILDING_WATER_LIFT},
  {HOTKEY_BUILD_CANAL, TR_NONE, GROUP_BUILDINGS, BUILDING_IRRIGATION_DITCH},
  {HOTKEY_BUILD_WATER_SUPPLY, TR_NONE, GROUP_BUILDINGS, BUILDING_WATER_SUPPLY},

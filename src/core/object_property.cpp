...
const xstring id_property_t::estimated_wages = "estimated_wages";
const xstring id_property_t::wages = "wages";
const xstring id_property_t::wages_kingdome = "wages_kingdome";

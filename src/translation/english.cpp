...
static translation_string all_strings[] = {
     ...
     {TR_CONFIG_DRAW_CLOUD_SHADOWS, "Draw cloud shadows (experimental)"},
     {TR_CONFIG_HEADER_SCENARIO_CHANGES, "Change scenarios"},
     {TR_CONFIG_HEADER_RESOURCES, "Change resources"},
     {TR_CONFIG_ANIMALS, "Change animals"},
     {TR_CONFIG_FLOTSAM, "Flotsam"},
     {TR_GAMEPLAY_GOD_DISABLED, "God disabled"},

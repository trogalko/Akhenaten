...
enum e_translate_key {
    ...
    TR_CONFIG_FIX_IRRIGATION_RANGE,
    TR_CONFIG_FIX_FARM_PRODUCING,
    TR_CONFIG_CAMERA_KEEP_INERTIA,
    TR_CONFIG_UNDERSTAFFED_ACCEPT_GOODS,
    TR_CONFIG_MULTIPLE_TEMPLE_COMPLEXES,
    TR_CONFIG_MULTIPLE_MONUMENTS,
    TR_CONFIG_SOIL_DEPLETION,
    TR_CONFIG_MULTIPLE_GATHERERS,
    ...
    TR_CONFIG_HEADER_SCENARIO_CHANGES,
    TR_GAMEPLAY_GOD_DISABLED,
    TR_HOTKEY_TITLE,
    TR_HOTKEY_LABEL,
